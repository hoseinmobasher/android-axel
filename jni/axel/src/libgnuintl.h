...
/* Look up MSGID in the DOMAINNAME message catalog for the current
 LC_MESSAGES locale.  */
#ifdef _INTL_REDIRECT_INLINE
extern LIBINTL_DLL_EXPORTED char *libintl_dgettext(const char *__domainname,
		const char *__msgid)
...
/* Look up MSGID in the DOMAINNAME message catalog for the current CATEGORY
 locale.  */
#ifdef _INTL_REDIRECT_INLINE
extern LIBINTL_DLL_EXPORTED char *libintl_dcgettext(const char *__domainname,
...
/* Similar to `gettext' but select the plural form corresponding to the
 number N.  */
#ifdef _INTL_REDIRECT_INLINE
extern LIBINTL_DLL_EXPORTED char *libintl_ngettext(const char *__msgid1,
...
/* Similar to `dgettext' but select the plural form corresponding to the
 number N.  */
#ifdef _INTL_REDIRECT_INLINE
extern LIBINTL_DLL_EXPORTED char *libintl_dngettext(const char *__domainname,
...
#ifdef _INTL_REDIRECT_INLINE
extern LIBINTL_DLL_EXPORTED char *libintl_bindtextdomain(
		const char *__domainname, const char *__dirname);
...
#ifdef _INTL_REDIRECT_INLINE
extern LIBINTL_DLL_EXPORTED char *libintl_bind_textdomain_codeset(
